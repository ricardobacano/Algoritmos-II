...
uint64_t buscaMinimo(int vetor[], size_t tam, int valor, 
                        uint64_t* numComparacoes);
...
void inserir(int vetor[], size_t tam,int elemento, uint64_t* numComparacoes);

uint64_t merge(int vetor[],size_t inicio, size_t meio, size_t fim, uint64_t* numComparacoesint,int vetor_u[]);
